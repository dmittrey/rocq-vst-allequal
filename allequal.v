...
Module Info.
  ...
  Definition source_file := "allequal.c".
...
Definition _allequal : ident := $"allequal".
...
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _allequal (Tfunction ((tptr tuint) :: tint :: nil) tuint
                          cc_default))
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_allequal, Gfun(Internal f_allequal)) :: (_four, Gvar v_four) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _four :: _allequal :: ___builtin_debug ::
